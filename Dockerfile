...
RUN chmod +x /usr/src/comgis/tasks.py \
    && chmod +x /usr/src/comgis/entrypoint.sh
...
ENTRYPOINT service cron restart && service memcached restart && /usr/src/comgis/entrypoint.sh
